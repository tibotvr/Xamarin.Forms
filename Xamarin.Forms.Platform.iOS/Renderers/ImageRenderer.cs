...
namespace Xamarin.Forms.Platform.iOS
{
	...
	public sealed class FontImageSourceHandler : IImageSourceHandler
	{
			...
			float scale = 1f)
		{
			...
			if (fontsource != null)
			{
				var iconcolor = fontsource.Color != Color.Default ? fontsource.Color : Color.Black;
				var imagesize = new SizeF((float)fontsource.Size, (float)fontsource.Size);
				var font = fontsource.FontFamily != null && UIFont.FamilyNames.Contains(fontsource.FontFamily) ?
